                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="block flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm"
                  ...
                  <div className="bg-gray-50 rounded-lg p-2">
                    {formData.subcategories.length === 0 ? (
                      <p className="text-sm text-gray-500 text-center py-2">
                        Sub-kategoriyalar qo'shilmagan
                      </p>
                    ) : (
                      <ul className="space-y-1">
                        {formData.subcategories.map(subcategory => (
                          <li 
                            key={subcategory.id}
                            className="flex items-center justify-between bg-white px-3 py-2 rounded-md text-sm"
                          >
